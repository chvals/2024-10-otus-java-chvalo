...
public class UsersWebServerWithBasicSecurity extends UsersWebServerSimple {
    ...
    public UsersWebServerWithBasicSecurity(
            int port, LoginService loginService, DBServiceClient dbServiceClient, ObjectMapper mapper, TemplateProcessor templateProcessor) {
        super(port, dbServiceClient, mapper, templateProcessor);
